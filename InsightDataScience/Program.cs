...
namespace InsightDataScience
{
    ...
    you can run project easily by going to bin\debug folder of project and run the InsightDataScience.exe. 
    I have run project many times by putting tweets.txt from data_gen folder. the output is available on ft1 and ft2.
